...
call add_employee('Manager', 'Tester', 999, 'Test@email.com', 9.99, current_date - 1, 'Manager', 'Test1', 'Test2');
select area_name, 2 from course_areas where area_name in ('Test1', 'Test2'); -- 2 rows
call add_employee('Administrator', 'Tester', 999, 'Test@email.com', 9.99, current_date - 1, 'Administrator');
call add_employee('PT_Instructor', 'Tester', 999, 'Test@email.com', 9.99, current_date - 1, 'Part-time instructor', 'Test1', 'Test2');
call add_employee('FT_Instructor', 'Tester', 999, 'Test@email.com', 9.99, current_date - 1, 'Full-time instructor', 'Test1', 'Test2');
select *, 4 from employees where join_date = current_date - 1; -- 4 rows
...
call add_course_offering(17, current_date, 1010, current_date + 5, 100, 48,
                         Array [[(current_date + 15)::text, '14:00', '1'], [(current_date + 15)::text, '15:00', '2'],
                             [(current_date + 15)::text, '16:00', '1'], [(current_date + 15)::text, '17:00', '1']]);

select *, 4 from sessions where course_id = 17;


-- Routine 2: remove employee
call add_employee('ToDelete', 'Tester', 999, 'Test@email.com', 9.99, current_date - 10, 'Administrator');
call remove_employee(51, current_date);
call remove_employee(50, '2021-04-26');
call remove_employee(49, current_date + 10); -- warning message
select *, 2 from employees where address = 'Tester' and depart_date is not null; -- 2 rows


-- Routine 3: add customer
call add_customer('Cust1', 'Tester', 999, 'Test@email.com', '0000000000000000', current_date + 365, '000');
call add_customer('Cust2', 'Tester', 999, 'Test@email.com', '1111111111111111', current_date + 365, '111');
select *, 2 from customers where address = 'Tester'; -- 2 rows


-- Routine 4: update credit card
call update_credit_card(41, '4141414141414141', current_date + (365 * 2), '414');
call update_credit_card(42, '4242424242424242', current_date + (365 * 2), '424');
-- reactivate old card
call update_credit_card(41, '0000000000000000', current_date + (365), '000');
select cc.*, 4 from customers natural join credit_cards cc where address = 'Tester'; --4 rows


-- Routine 6: find instructors
select * from find_instructors(17, current_date + 15, '14:00'); -- 0 rows
select * from find_instructors(17, current_date + 12, '14:00'); -- 2 row
select * from find_instructors(17, current_date + 20, '14:00'); -- 1 row (instructor left)


-- Routine 7: get available instructors
call add_course_offering(17, current_date - 1, 10, current_date + 5, 100, 48,
                         Array [[(current_date + 19)::text, '9:00', '5']]);

select * from employees where address = 'Tester' and depart_date is not null; -- 2 rows
select * from sessions where course_id = 17;

select * from get_available_instructors(17, current_date + 10, current_date + 20);

-- Routine 24: add session
call add_session(17, current_date - 1, 10, '2021-04-26', '17:00', 49, 10);

-- Routine 8: find rooms
select * from find_rooms('2021-04-26', '17:00', 1);

-- Routine 22: update room
call update_room(17, current_date - 1, 10, 1);

-- Routine 21: update instructor
select * from find_instructors(17, '2021-04-26', '17:00');
call update_instructor(17, current_date - 1, 10, 50);

-- Routine 9: get avail rooms
select * from get_available_rooms(current_date + 10, current_date + 20);

-- Routine 23: remove session
call remove_session(17, current_date - 1, 10);

-- Routine 11: add course packages
call add_course_package('Test Package', 1, current_date, current_date + 50, 100.25);
...
select * from get_available_course_sessions(17, current_date);

-- Routine 17: register session
call register_session(41, 17, current_date, 1, 'card');
call register_session(42, 17, current_date - 1, 1, 'card');

call register_session(41, 17, current_date - 1, 1, 'redeem');
call register_session(42, 17, current_date, 3, 'redeem');
...
call cancel_registration(41, 17, current_date);
select * from get_my_registrations(41);
call register_session(41, 17, current_date, 2, 'card');
select * from get_my_registrations(41);

-- Routine 19: update course session
call update_course_session(41, 17, current_date, 4);
select * from get_my_registrations(41);
